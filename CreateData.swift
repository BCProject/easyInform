...
class CreateData {
    init(){
        ...
        template1Item1.item_type = ItemType.DATE_MD_SLA
        ...
        template1Item2.item_type = ItemType.TIME_HMM_COL
        ...
        template1Item3.item_type = ItemType.TEXTFIELD
        template1Item3.item_image = ItemImage.REASON
        ...
        template1Item4.item_type = ItemType.TEXTFIELD
        template1Item4.item_image = ItemImage.NOTE
        ...
        template2Head.mail_title = "【勤怠連絡】早退 {取得日}{取得曜日} 佐藤"
        ...
        template2Item1.item_type = ItemType.DATE_MD_SLA
        ...
        template2Item2.item_title = "取得曜日"
        template2Item2.item_type = ItemType.DAY
        template2Item2.item_image = ItemImage.DATE
        template2Item2.item_content = "(月)"
        ...
        template2Item3.item_title = "退社時刻"
        template2Item3.item_type = ItemType.TIME_HMM_COL
        template2Item3.item_image = ItemImage.TIME
        template2Item3.item_content = "15:00"
        ...
        // テンプレート2 アイテム4作成
        let template2Item4 = TemplateItem()
        template2Item4.item_title = "理由"
        template2Item4.item_type = ItemType.TEXTFIELD
        template2Item4.item_image = ItemImage.REASON
        template2Item4.item_content = "体調不良"
        template2Item4.disp_no = 3
        template2Item4.template_head = template2Head
        template2Head.templateItem.addObject(template2Item4)
        if (TemplateItem.insertAllTemplateItem(template2Item4) == false) {
            return
        }
    }
}
