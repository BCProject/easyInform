...
class ItemSelectWindow: UIWindow {
    ...
    // ダイアログ表示
    func drawItemSelectWindow (vc: UIViewController, textView: UITextView, drawX: CGFloat, drawY: CGFloat) {
        ...
        _doneButton.addTarget(self, action: "onClickDoneButton", forControlEvents: .TouchUpInside)
